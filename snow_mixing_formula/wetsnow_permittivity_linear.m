function eps_eff = wetsnow_permittivity_linear(freqGHz, density, lwc, ice_permittivity_model, water_permittivity_model)
...
% Siberstein Formula, Sihvola 1999 Eq. 9.12
eps_eff = fw*ew + (1-fw)*epsd; 
