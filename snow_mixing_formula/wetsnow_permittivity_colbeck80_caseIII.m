function eps_eff = wetsnow_permittivity_colbeck80_caseIII(frequency, density, liquid_water, ice_permittivity_model, water_permittivity_model)
...
eps0=ice_permittivity_model(frequency, temperature);
eps1=water_permittivity_model(frequency, temperature);
eps2=1;

eps_eff=polder_van_santen_three_components(fw,1-frac_volume,eps0, eps1, eps2, Awater,Aair);
